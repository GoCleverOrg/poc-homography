...
pytestmark = pytest.mark.skipif(
    not MAP_POINTS_PATH.exists() or not ANNOTATIONS_PATH.exists() or not VALTE_IMAGE_PATH.exists(),
...
class TestGCPRegistryLoading:
    ...
    def test_load_map_point_registry(self, map_point_registry):
        ...
        assert len(map_point_registry.points) == 72  # PS1-34, AR1-9, EX1-7, CW1-22
