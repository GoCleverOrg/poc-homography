...
_.load_calibration  # unused method (poc_homography/camera_parameters.py:77)
_.writeable  # unused attribute (poc_homography/camera_parameters.py:261)
_.writeable  # unused attribute (poc_homography/camera_parameters.py:272)
_.writeable  # unused attribute (poc_homography/camera_parameters.py:290)
_.writeable  # unused attribute (poc_homography/camera_parameters.py:437)
_.writeable  # unused attribute (poc_homography/camera_parameters.py:448)
...
_.delete  # unused method (poc_homography/domain/repositories/repo.py:50)
...
_.delete  # unused method (poc_homography/infrastructure/repositories/base/repo_yaml.py:84)
_.clear_cache  # unused method (poc_homography/infrastructure/repositories/base/repo_yaml.py:98)
_.delete  # unused method (poc_homography/infrastructure/repositories/repo_yaml_captured_frame.py:87)
_.get_by_map  # unused method (poc_homography/infrastructure/repositories/repo_yaml_captured_frame.py:127)
_.get_by_camera  # unused method (poc_homography/infrastructure/repositories/repo_yaml_captured_frame.py:148)
_.clear_cache  # unused method (poc_homography/infrastructure/repositories/repo_yaml_captured_frame.py:176)
_.get_image_path  # unused method (poc_homography/infrastructure/repositories/repo_yaml_captured_frame.py:180)
_.get_annotations  # unused method (poc_homography/infrastructure/repositories/repo_yaml_captured_frame.py:205)
_.save_annotations  # unused method (poc_homography/infrastructure/repositories/repo_yaml_captured_frame.py:227)
...
_.modified  # unused attribute (webapp/camera_line_annotator/views.py:124)
...
urlpatterns  # unused variable (webapp/gcp/urls.py:19)
...
homography_source  # unused variable (webapp/homography_precision/views.py:976)
line_result  # unused variable (webapp/homography_precision/views.py:991)
...
LinePickerConfig  # unused class (webapp/line_picker/apps.py:8)
default_auto_field  # unused variable (webapp/line_picker/apps.py:11)
verbose_name  # unused variable (webapp/line_picker/apps.py:13)
_.ready  # unused method (webapp/line_picker/apps.py:15)
...
PointPickerConfig  # unused class (webapp/point_picker/apps.py:8)
default_auto_field  # unused variable (webapp/point_picker/apps.py:11)
verbose_name  # unused variable (webapp/point_picker/apps.py:13)
...
extract_point_annotations_ref  # unused function (webapp/camera_line_annotator/views.py) - legacy compat
