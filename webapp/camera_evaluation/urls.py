...
urlpatterns = [
    ...
    path("api/stress-test/<str:session_id>/status/", views.api_stress_test_status, name="api_stress_test_status"),
    path("api/stress-test/<str:session_id>/abort/", views.api_stress_test_abort, name="api_stress_test_abort"),
    # Stress test session management
    path("api/stress-test/sessions/", views.api_stress_test_sessions, name="api_stress_test_sessions"),
    path("api/stress-test/sessions/<str:session_id>/", views.api_stress_test_session_detail, name="api_stress_test_session_detail"),
    path("api/stress-test/sessions/<str:session_id>/evaluate/", views.api_stress_test_evaluate, name="api_stress_test_evaluate"),
    path("api/stress-test/sessions/<str:session_id>/delete/", views.api_stress_test_delete, name="api_stress_test_delete"),
