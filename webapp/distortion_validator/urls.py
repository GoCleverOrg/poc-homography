...
urlpatterns = [
    ...
    path(
        "api/measure-straightness/", views.api_measure_straightness, name="api_measure_straightness"
    ),
    path("api/transform-points/", views.api_transform_points, name="api_transform_points"),
    path(
        "api/result-image/<str:filename>",
        views.api_serve_result_image,
        name="api_serve_result_image",
    ),
