...
class MapPoint:
    ...
    The ID and map association are managed externally by GCPRegistry,
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        Returns:
            ...
            Note: The id is managed by the GCPRegistry and added during serialization.
        """
        return {
    ...
    def from_dict(cls, data: dict[str, Any]) -> MapPoint:
        ...
        Args:
            data: Dictionary with pixel_x and pixel_y keys.
                  The id key (if present) is ignored as it's managed by GCPRegistry.
